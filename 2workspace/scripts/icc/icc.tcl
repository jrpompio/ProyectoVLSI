...
set SCRIPTS_DIR "$env(HOME)/ie0411/proyecto/2workspace/scripts/" ; # DONDE SEA QUE COPIARON LOS SCRIPTS
set SDC_FILE "$env(HOME)/ie0411/proyecto/2workspace/WORK/results/system.sdc" ; # ESTE ARCHIVO ES EL GENERADO POR SINTESIS, NO EL DADO POR EL PROFESOR PARA INICIAR SINTESIS
set WDIR "$env(HOME)/ie0411/proyecto/2workspace/WORK" ; #ES NECESARIO MODIFICAR AL HOME USUARIO CORRECTO
set TOP ${WDIR}/..
set gate_verilog "$env(HOME)/ie0411/proyecto/2workspace/WORK/results/system.v" ; #ES NECESARIO MODIFICAR AL PATH CORRECTO


##########################################################################################
# CONFIGURACIONES GENERALES
##########################################################################################
set COMMON_SETUP_SCRIPT "$env(HOME)/ie0411/proyecto/2workspace/scripts/icc/common_setup.tcl"
