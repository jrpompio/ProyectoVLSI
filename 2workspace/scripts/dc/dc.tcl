...
set TOP ${WDIR}/..
set verilog_path "$env(HOME)/ie0411/proyecto/2workspace/rtl"
set rtl_list_path "$env(HOME)/ie0411/proyecto/2workspace/scripts/dc/rtl.list"
...
source -e -v "$env(HOME)/ie0411/proyecto/2workspace/scripts/dc/constraints.sdc"
